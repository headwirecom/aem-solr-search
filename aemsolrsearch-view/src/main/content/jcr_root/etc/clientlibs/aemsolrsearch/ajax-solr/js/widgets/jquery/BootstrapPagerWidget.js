 ...
 * @class BootstrapPagerWidget
 * @augments AjaxSolr.AbstractWidget
 * @todo Don't use the manager to send the request. Request only the results,
 * not the facets. Update only itself and the results widget.
 */
AjaxSolr.BootstrapPagerWidget = AjaxSolr.AbstractWidget.extend(
  /** @lends AjaxSolr.BootstrapPagerWidget.prototype */
  {
  /**
  ...
  constructor: function (attributes) {
    AjaxSolr.BootstrapPagerWidget.__super__.constructor.apply(this, arguments);
  ...
  windowedLinks: function () {
    ...
    for (var i = 0, l = visible.length; i < l; i++) {
      ...
      links.push(this.pageLinkOrSpan(visible[i], [ 'active' ]));
      prev = visible[i];
    }
