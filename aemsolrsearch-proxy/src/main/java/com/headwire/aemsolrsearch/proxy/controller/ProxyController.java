...
public abstract class ProxyController {
    ...
    public Integer httpConnTimeout;

    @Value("${http.socket.timeout}")
    public Integer httpSoTimeout;
     ...
     * @return
     */
    public abstract String getTargetURI(HttpServletRequest request);
     ...
     * @return
     */
    public abstract boolean isValidRequest(HttpServletRequest request);
