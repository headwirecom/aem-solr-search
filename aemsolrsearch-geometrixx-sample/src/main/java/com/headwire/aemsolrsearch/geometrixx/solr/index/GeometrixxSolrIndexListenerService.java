...
@Component (
        name = "com.headwire.aemsolrsearch.index.services.GeometrixxSolrIndexListenerService",
        label = "AEM Solr Search - Geometrixx Solr Index Listener",
 ...
 */
public class GeometrixxSolrIndexListenerService implements EventHandler {

    private static final Logger LOG = LoggerFactory.getLogger(GeometrixxSolrIndexListenerService.class);

    private Boolean serviceEnabled;
    private String[] observedPaths;

    @Reference
    private GeometrixxSolrIndexService indexService;
