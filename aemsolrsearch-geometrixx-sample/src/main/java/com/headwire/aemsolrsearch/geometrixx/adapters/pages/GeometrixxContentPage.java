...
/**
 * Data model representing a Geometrixx Content page.
 *
 * @author <a href="mailto:gg@headwire.com">Gaston Gonzalez</a>
 */
public class GeometrixxContentPage extends GeometrixxContentType {

    private static final Logger LOG = LoggerFactory.getLogger(GeometrixxContentPage.class);
    ...
    public static GeometrixxContentPage adaptFromResource(Resource resource) {
    ...
    public GeometrixxContentPage withDescription(String description) {
        this.description = description;
        return this;
    }

    public GeometrixxContentPage withLastUpdate(Date lastUpdate) {
        this.lastUpdate = lastUpdate;
        return this;
    }

    public GeometrixxContentPage withSlingResourceType(String slingResourceType) {
        this.slingResourceType = slingResourceType;
        return this;
    }

    public GeometrixxContentPage withTitle(String title) {
        this.title = title;
        return this;
    }

    public GeometrixxContentPage withUrl(String url) {
        this.url = url;
        return this;
    }
